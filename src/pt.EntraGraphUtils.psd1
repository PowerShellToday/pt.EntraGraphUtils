@{
    ...
    Copyright         = '(c) 2026 PowerShell.Today. All rights reserved.'
    ...
    PrivateData       = @{
        PSData = @{
            ...
            ReleaseNotes = 'Replaced domain-specific helpers with general-purpose Graph API functions: Invoke-ptGraphBatchRequest (JSON batch with auto-retry and pagination), Invoke-ptGraphRequest (individual requests), and New-ptGraphRequestItem (request object builder with OData parameter support).'
        }
    }
}
